...
const copy = {
  fr: {
    languageLabel: 'Langue', back: 'Retour au site', loginEyebrow: 'Connexion', loginTitle: 'Bon retour.', loginSub: 'Accedez a vos velos, carte et profil.', loginVisualTitle: 'Reprenez la route.', loginVisualText: 'Stations, QR et trajets au meme endroit.', email: 'Adresse e-mail', password: 'Mot de passe', remember: 'Se souvenir de moi', forgot: 'Mot de passe oublié ?', loginSubmit: 'Me connecter', loginLoading: 'Connexion en cours...', loginSuccess: 'Connexion réussie. Redirection vers votre espace.', loginSwitch: 'Pas encore de compte ?', loginSwitchLink: 'Créer un compte', signupEyebrow: 'Inscription', signupTitle: 'Creez votre compte.', signupSub: 'Quelques infos, puis vous roulez.', signupVisualTitle: 'Votre trajet commence ici.', signupVisualText: 'Stations, QR et support dans votre espace.', firstName: 'Prénom', lastName: 'Nom', phone: 'Téléphone', confirmPassword: 'Confirmer le mot de passe', termsText: 'J\'accepte les conditions et la confidentialite.', signupSubmit: 'Créer mon compte', signupLoading: 'Création en cours...', signupSuccess: 'Compte cree. Verifiez votre email.', signupSwitch: 'Déjà un compte ?', signupSwitchLink: 'Me connecter', weak: 'Trop faible', medium: 'Moyen', strong: 'Fort', veryStrong: 'Très fort', required: 'Veuillez remplir tous les champs obligatoires.', firstNameRequired: 'Veuillez entrer votre prénom.', lastNameRequired: 'Veuillez entrer votre nom.', emailRequired: 'Veuillez entrer votre adresse email.', passwordRequired: 'Veuillez choisir un mot de passe.', loginPasswordRequired: 'Veuillez entrer votre mot de passe.', badEmail: 'Veuillez entrer une adresse e-mail valide.', badPassword: 'Le mot de passe doit contenir au moins 12 caractères.', mismatch: 'Les mots de passe ne correspondent pas.', acceptTerms: 'Veuillez accepter les conditions.'
  },
  en: {
    languageLabel: 'Language', back: 'Back to site', loginEyebrow: 'Log in', loginTitle: 'Welcome back.', loginSub: 'Access your bikes, map, and profile.', loginVisualTitle: 'Ride again.', loginVisualText: 'Stations, QR, and rides in one place.', email: 'Email address', password: 'Password', remember: 'Remember me', forgot: 'Forgot password?', loginSubmit: 'Log in', loginLoading: 'Logging in...', loginSuccess: 'Login successful. Redirecting to your space.', loginSwitch: 'No account yet?', loginSwitchLink: 'Create account', signupEyebrow: 'Sign up', signupTitle: 'Create your account.', signupSub: 'A few details, then ride.', signupVisualTitle: 'Your ride starts here.', signupVisualText: 'Stations, QR, and support in your space.', firstName: 'First name', lastName: 'Last name', phone: 'Phone', confirmPassword: 'Confirm password', termsText: 'I accept the terms and privacy policy.', signupSubmit: 'Create my account', signupLoading: 'Creating account...', signupSuccess: 'Account created. Check your email.', signupSwitch: 'Already have an account?', signupSwitchLink: 'Log in', weak: 'Too weak', medium: 'Medium', strong: 'Strong', veryStrong: 'Very strong', required: 'Please fill in all required fields.', firstNameRequired: 'Please enter your first name.', lastNameRequired: 'Please enter your last name.', emailRequired: 'Please enter your email address.', passwordRequired: 'Please choose a password.', loginPasswordRequired: 'Please enter your password.', badEmail: 'Please enter a valid email address.', badPassword: 'Password must be at least 12 characters.', mismatch: 'Passwords do not match.', acceptTerms: 'Please accept the terms.'
  }
};
copy.es = {
  ...copy.en,
  languageLabel: 'Idioma', back: 'Volver al sitio', loginEyebrow: 'Conexión', loginTitle: 'Bienvenido.', loginSub: 'Bicis, mapa y perfil.', loginVisualTitle: 'Vuelve a pedalear.', loginVisualText: 'Estaciones, QR y trayectos juntos.', loginSubmit: 'Conectarme', loginLoading: 'Conectando...', loginSuccess: 'Conexión correcta. Redirección a tu espacio.', loginSwitch: '¿Aún no tienes cuenta?', loginSwitchLink: 'Crear cuenta', signupEyebrow: 'Registro', signupTitle: 'Crea tu cuenta.', signupSub: 'Unos datos y a pedalear.', signupVisualTitle: 'Tu viaje empieza aqui.', signupVisualText: 'Estaciones, QR y soporte en tu espacio.', firstName: 'Nombre', lastName: 'Apellido', phone: 'Teléfono', confirmPassword: 'Confirmar contraseña', termsText: 'Acepto las condiciones y la política de privacidad.', signupSubmit: 'Crear mi cuenta', signupLoading: 'Creando cuenta...', signupSuccess: 'Cuenta creada. Revisa tu email.', signupSwitch: '¿Ya tienes cuenta?', signupSwitchLink: 'Conectarme', required: 'Completa todos los campos obligatorios.', firstNameRequired: 'Introduce tu nombre.', lastNameRequired: 'Introduce tu apellido.', emailRequired: 'Introduce tu email.', passwordRequired: 'Elige una contraseña.', loginPasswordRequired: 'Introduce tu contraseña.', badEmail: 'Introduce un email válido.', badPassword: 'La contraseña debe tener al menos 12 caracteres.', mismatch: 'Las contraseñas no coinciden.', acceptTerms: 'Acepta las condiciones.'
};
copy.pt = {
  ...copy.en,
  languageLabel: 'Idioma', back: 'Voltar ao site', loginEyebrow: 'Entrar', loginTitle: 'Bem-vindo.', loginSub: 'Bikes, mapa e perfil.', loginVisualTitle: 'Volte a pedalar.', loginVisualText: 'Estacoes, QR e viagens juntos.', loginSubmit: 'Entrar', loginLoading: 'A entrar...', loginSuccess: 'Sessão iniciada. Redirecionando para o seu espaço.', loginSwitch: 'Ainda não tem conta?', loginSwitchLink: 'Criar conta', signupEyebrow: 'Cadastro', signupTitle: 'Crie sua conta.', signupSub: 'Alguns dados e pronto.', signupVisualTitle: 'Sua viagem comeca aqui.', signupVisualText: 'Estacoes, QR e suporte no seu espaco.', firstName: 'Nome', lastName: 'Sobrenome', phone: 'Telefone', confirmPassword: 'Confirmar senha', termsText: 'Aceito os termos e a política de privacidade.', signupSubmit: 'Criar minha conta', signupLoading: 'Criando conta...', signupSuccess: 'Conta criada. Verifique seu email.', signupSwitch: 'Já tem conta?', signupSwitchLink: 'Entrar', required: 'Preencha todos os campos obrigatórios.', firstNameRequired: 'Insira o seu nome.', lastNameRequired: 'Insira o seu sobrenome.', emailRequired: 'Insira o seu email.', passwordRequired: 'Escolha uma senha.', loginPasswordRequired: 'Insira a sua senha.', badEmail: 'Insira um email válido.', badPassword: 'A senha deve ter pelo menos 12 caracteres.', mismatch: 'As senhas não coincidem.', acceptTerms: 'Aceite os termos.'
};
copy.ar = {
  ...copy.en,
